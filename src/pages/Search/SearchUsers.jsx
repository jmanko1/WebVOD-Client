    ...
    return (
        <div className="container mt-4">
            ...
            {!error && users.map((user) => (
                <div className="row mb-4 align-items-sm-center" key={user.login}>
                    <div className="col-12 col-sm-2 pe-sm-0" style={{maxWidth: "172px"}}>
                    ...
                    <div className="col-12 col-sm-10 ps-0 mt-2 mt-sm-0 ps-sm-2">
